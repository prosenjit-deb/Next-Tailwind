...
import RedGradient from './../../../../assets/images/red-gradient-bg.png';
import WhiteVideo from './../../../../assets/images/icons/white-video.svg';
import WhiteImage from './../../../../assets/images/icons/white-image.svg';
import WhiteTicon from './../../../../assets/images/icons/white-ticon.svg';
import WhiteUsers from './../../../../assets/images/icons/white-users.svg';
                ...
                <div className=' max-w-[570px] flex flex-col gap-5'>
                  ...
                  <div>
                    <div className='relative'>
                      <Image src={RedGradient} alt='' />
                      <div className='w-full absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center flex flex-col justify-between h-full pt-10 pb-7'>
                        <div className='relative'>
                          <h1 className='text-[32px] text-white font-semibold uppercase'>Welcome To My Club</h1>
                          <h2 className='text-[18px] text-white'>Nicolette Bloom</h2>
                        </div>

                        <div className='relative'>
                          <ul className='divide-x divide-[#C3557C] flex items-center justify-center'>
                            <li className='flex flex-wrap gap-[5px] px-4'>
                              <Image src={WhiteVideo} alt='' />
                              <span className='text-white text-[13px] uppercase tracking-[0.13px]'>203</span>
                            </li>
                            <li className='flex flex-wrap gap-[5px] px-4'>
                              <Image src={WhiteImage} alt='' />
                              <span className='text-white text-[13px] uppercase tracking-[0.13px]'>500</span>
                            </li>
                            <li className='flex flex-wrap gap-[5px] px-4'>
                              <Image src={WhiteTicon} alt='' />
                              <span className='text-white text-[13px] uppercase tracking-[0.13px]'>25</span>
                            </li>
                            <li className='flex flex-wrap gap-[5px] px-4'>
                              <Image src={WhiteUsers} alt='' />
                              <span className='text-white text-[13px] uppercase tracking-[0.13px]'>5000</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className='bg-white p-4'>
                      <div className='max-w-[290px] mx-auto'>
                        <Button variant="default">Subscribe For $23.50/Month</Button>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className='absolute top-0 right-0'>
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button variant="link" className="p-0 w-8 h-10 rounded-full focus:outline-none hover:bg-gray-100">
