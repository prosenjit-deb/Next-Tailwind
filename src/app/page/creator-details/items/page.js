...
import ContentImg from './../../../../assets/images/red-metal-handle.jpeg';
            ...
            <div className=' flex-1 w-full lg:w-8/12 xl:w-9/12'>
              ...
              <div className='bg-white px-7 rounded-[9px] mb-9'>
                <ul className='flex gap-8 text-[#333] text-sm'>
                  ...
                  <li className='relative py-4 text-black font-semibold after:bg-[#ED2227] after:h-[3px] after:w-full after:left-0 after:bottom-0 after:absolute cursor-pointer'>Items</li>
              ...
              <div className='w-full'>
                ...
                <div className='flex flex-col'>
                  {/* Start Item Section Header Component */}
                  <div className='flex flex-wrap items-center justify-between mb-5'>
                    <h2 className=' uppercase text-black font-semibold text-[16px]'>All Items (321)</h2>
                    <div>
                      <Sorting />
                    </div>
                  </div>
                  {/* End Item Section Header Component */}

                  {/* Start Items Section Grid Component */}
                  <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6'>

                    {/* Start Each Items Grid Component */}
                    <div className='bg-white border border-[#F2F2F2] rounded-[10px] overflow-hidden'>
                      ...
                      <div className='bg-white w-full relative px-4 pt-5 pb-5'>
                        <h3 className='text-[15.75px] text-[#16161D]'>Satin Lingerie Set</h3>
                        <small className='text-[#F80E0E] text-[13.65px]'>$19.99</small>
                        <div className='flex justify-between items-center mt-4'>
                          <Button variant="default" className="h-7 min-w-24 px-4">More Info</Button>
                    ...
                    {/* Start Each Items Grid Component */}
                  </div>{/* Start Items Section Grid Component */}
                  <Pagination />
                </div>
